package app.homework_9.main.dao;

import app.homework_9.main.model.Family;
import app.homework_9.main.model.Human;
import app.homework_9.main.model.Pet;

import java.util.ArrayList;
import java.util.List;
import java.util.stream.Collectors;

public class CollectionFamilyDao implements app.homework_9.main.dao.FamilyDao {
    ...
    public void deleteAllChildrenOlderThen(int age) {
        ...
        familiesWithChildren.forEach(family -> family.getChildren().forEach(child -> {
            if (CURRENT_YEAR - child.getBirthDate() > age) {
